...
public class PlayerMovementSystem : SystemBase
{
    protected override void OnUpdate()
    {
        ...
        Entities.ForEach((ref PhysicsVelocity p_physicsVelocity, ref Translation p_translation, ref Rotation p_rotation,
            ref PlayerMovementData p_movementData, in PhysicsMass p_physicsMass) =>
        {
            ...
            float3 l_angularVelocity = new float3(0f, 1f, 0f) * math.radians(p_movementData.TorqueForce * l_deltaTime);
            quaternion l_inertiaOrientationInWorldSpace = math.mul(p_rotation.Value, p_physicsMass.InertiaOrientation);
